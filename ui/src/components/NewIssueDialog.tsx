...
/* statuses, priorities, and EXECUTION_WORKSPACE_MODES moved inside NewIssueDialog for i18n */
...
export function NewIssueDialog() {
  ...
  const EXECUTION_WORKSPACE_MODES = [
    { value: "shared_workspace", label: t('newIssueDialog.wsProjectDefault') },
    { value: "isolated_workspace", label: t('newIssueDialog.wsNewIsolated') },
    { value: "reuse_existing", label: t('newIssueDialog.wsReuseExisting') },
  ] as const;
