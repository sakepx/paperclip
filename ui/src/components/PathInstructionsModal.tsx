...
const instructionKeys: Record<Platform, { stepKeys: string[]; tipKey?: string }> = {
  mac: {
    stepKeys: [
      "pathInstructions.macStep1",
      "pathInstructions.macStep2",
      "pathInstructions.macStep3",
      "pathInstructions.macStep4",
    ],
    tipKey: "pathInstructions.macTip",
  },
  windows: {
    stepKeys: [
    ...
    tipKey: "pathInstructions.windowsTip",
  },
  linux: {
    stepKeys: [
    ...
    tipKey: "pathInstructions.linuxTip",
  },
};
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            {t('pathInstructions.description').split('/Users/you/project')[0]}
            <code className="text-xs bg-muted px-1 py-0.5 rounded">/Users/you/project</code>
            {t('pathInstructions.description').split('/Users/you/project')[1]}
          </DialogDescription>
        </DialogHeader>
