        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {isBudgetApproval && approval.status === "pending" && (
            <p className="text-sm text-muted-foreground">
              {t('approvalDetail.budgetResolveNote').split('/costs')[0]}<Link to="/costs" className="underline underline-offset-2">/costs</Link>{t('approvalDetail.budgetResolveNote').split('/costs')[1] || ''}
            </p>
          )}
          ...
          {approval.status === "rejected" && approval.type === "hire_agent" && linkedAgentId && (
            ...
            >
              {t('approvalDetail.deleteDisapproved')}
            </Button>
          )}
        </div>
      </div>
