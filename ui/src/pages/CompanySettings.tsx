    ...
    <div className="max-w-2xl space-y-6">
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          ...
          <div className="space-y-1 text-xs text-muted-foreground">
            ...
            {selectedCompany.feedbackDataSharingConsentAt ? (
              <div>
                {t('companySettings.enabled')}{new Date(selectedCompany.feedbackDataSharingConsentAt).toLocaleString()}
                {selectedCompany.feedbackDataSharingConsentByUserId
                  ? `${t('companySettings.by')}${selectedCompany.feedbackDataSharingConsentByUserId}`
                  : ""}
              </div>
            ) : (
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border px-4 py-4">
          <p className="text-sm text-muted-foreground">
            {t('companySettings.packagesMovedNote')}{" "}
            <a href="/org" className="underline hover:text-foreground">{t('companySettings.orgChart')}</a>{t('companySettings.headerSuffix')}
          </p>
