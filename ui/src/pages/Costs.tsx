      ...
      <div className="space-y-5">
          ...
          <div className="grid gap-3 lg:grid-cols-4">
            ...
            <MetricTile
              ...
              subtitle={`${formatCents(financeData?.summary.debitCents ?? 0)} ${t('costs.debits').toLowerCase()} · ${formatCents(financeData?.summary.creditCents ?? 0)} ${t('costs.credits').toLowerCase()}`}
              icon={ReceiptText}
            />
            <MetricTile
                    ...
                    {spendData?.summary.budgetCents && spendData.summary.budgetCents > 0 ? (
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {t('costs.usagePercent', { percent: spendData.summary.utilizationPercent })}
                        </div>
                      </div>
                    ) : null}
                  </CardContent>
