              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-100/70">
                    {t('dashboard.incidentDetails', { agents: data.budgets.pausedAgents, projects: data.budgets.pausedProjects, approvals: data.budgets.pendingApprovals })}
                  </p>
                </div>
              </div>
              <Link to="/costs" className="text-sm underline underline-offset-2 text-red-100">
                {t('actions.openBudgets')}
              </Link>
            </div>
          ) : null}
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? t('dashboard.budgetOf', { percent: data.costs.monthUtilizationPercent, amount: formatCents(data.costs.monthBudgetCents) })
