...
export function InstanceSettings() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      { label: t('instanceHeartbeats.title') },
    ]);
  }, [setBreadcrumbs, t]);
  ...
  return (
    <div className="max-w-5xl space-y-6">
        ...
        {anyEnabled && (
          <Button
            ...
            onClick={() => {
              ...
              if (!window.confirm(t('instanceHeartbeats.disableAllConfirm', { count: enabledCount, noun }))) {
                return;
              }
              disableAllMutation.mutate(agents);
            }}
          >
            {disableAllMutation.isPending ? t('instanceHeartbeats.disabling') : t('instanceHeartbeats.disableAll')}
          </Button>
        )}
      </div>
      ...
      {agents.length === 0 ? (
        <EmptyState
          icon={Clock3}
          message={t('instanceHeartbeats.noMatch')}
        />
      ) : (
                      ...
                      >
                        ...
                        <span className="ml-auto flex items-center gap-1.5 shrink-0">
                          <Link
                            ...
                            title={t('instanceHeartbeats.fullAgentConfig')}
                          >
